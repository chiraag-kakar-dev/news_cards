...
import 'package:news_cards/model/article_model.dart';
import 'dart:async';
...
class ApiService {
  ...
  final endPointUrl =
       Uri.parse('https://newsapi.org/v2/everything?q=tesla&from=2021-08-12&sortBy=publishedAt&apiKey=654d4945dfa54357bcb729fd2f4e7480');
